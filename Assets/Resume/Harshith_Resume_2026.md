# Govada Harshith
**B.Tech CSE (Data Science) | AI • Data • Cybersecurity • Full-Stack**

Hyderabad, India  
GitHub: https://github.com/Harshith2737  
LinkedIn: https://www.linkedin.com/in/govada-harshith/  
LeetCode: https://leetcode.com/u/Harsihth_2737/  
...
Multimodal industrial incident-investigation console combining vision, sensor, data and SOP/document signals into a unified diagnosis/action flow with human-in-the-loop approval. React 19, TanStack Start/Router, Tailwind CSS, Zustand, Recharts, LiveKit and Zod.

**Certificate Automation**  
Python workflow for participant-data driven certificate generation using deterministic IDs, HTML templates, Playwright PDF rendering, smoke tests, dry-runs and controlled SMTP delivery.
...
- Conducted and supported AI-awareness and technical workshops and helped organize industry-connected campus events with student communities and clubs.
